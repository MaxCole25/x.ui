...
<template>
  <Story title="元素/TimePicker 时间选择器" group="components">
    <Variant title="基础用法">
    ...
    <Variant title="状态与边界">
      <div class="story-stack">
        <XTimePicker v-model="emptyTime" clearable />
        <XTimePicker model-value="14:30" disabled />
        <XTimePicker model-value="08:45" readonly prefix="只读" />
      </div>
    </Variant>
