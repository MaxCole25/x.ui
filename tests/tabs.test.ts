...
describe('XTabs', () => {
  ...
  it('uses documented default visual variables', () => {
    ...
    expect(wrapper.attributes('style')).toContain('--x-tabs-tab-text: var(--x-color-text-muted)')
    expect(wrapper.attributes('style')).toContain('--x-tabs-tab-active-text: var(--x-color-primary)')
    ...
    expect(wrapper.attributes('style')).toContain('--x-tabs-content-bg: var(--x-color-surface)')
    expect(wrapper.attributes('style')).toContain('--x-tabs-context-menu-bg: var(--x-color-surface)')
