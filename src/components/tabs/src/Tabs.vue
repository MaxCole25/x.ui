...
const tabsStyleVars = computed<Record<string, string>>(() => ({
  ...
  '--x-tabs-tab-active-bg': props.activeTabBgColor,
...
function getTabsSizeVars(size: NonNullable<TabsProps['size']>) {
  const vars = {
    large: {
      '--x-tabs-item-height': '46px',
      '--x-tabs-item-min-height': '50px',
      '--x-tabs-item-min-width': '152px',
      '--x-tabs-item-padding-x': '16px',
      '--x-tabs-item-padding-y': '12px',
      '--x-tabs-label-font-size': '15px',
    ...
    default: {
      ...
      '--x-tabs-item-min-height': '44px',
      '--x-tabs-item-min-width': '140px',
      '--x-tabs-item-padding-x': '14px',
      '--x-tabs-item-padding-y': '10px',
    ...
    small: {
      ...
      '--x-tabs-item-padding-x': '12px',
      '--x-tabs-item-padding-y': '8px',
      '--x-tabs-label-font-size': '13px',
