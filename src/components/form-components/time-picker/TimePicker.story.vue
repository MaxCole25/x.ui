...
<template>
  <Story title="Form 组件/TimePicker 时间选择器" group="components">
    

    

    <Variant title="外观接口">
      <div class="time-picker-appearance">
        <div class="time-picker-appearance__preview">
          <div
            class="time-picker-appearance__preview-parent"
            :style="{
              width: sample.parentFullWidth ? '100%' : `${sample.parentWidth}px`,
              height: sample.parentFullHeight ? '100%' : `${sample.parentHeight}px`
            }"
          >
            <XTimePicker v-bind="componentSample" v-model="sample.modelValue" />
          </div>
          <div class="time-picker-appearance__preview-parent is-dark">
            <XTimePicker v-bind="darkTimePickerTheme" />
          </div>
        </div>

        <div class="time-picker-appearance__controls">
          <div class="time-picker-appearance__column">
            <label>
              <span>绑定值</span>
...
.time-picker-appearance__preview {
  align-items: center;
  background: #f8fafc;
  display: flex;
  min-height: 132px;
...
.time-picker-appearance__preview-parent {
  background: #ecfdf5;
  box-sizing: border-box;
  display: grid;
  padding: 10px;
...
.time-picker-appearance__preview-parent.is-dark {
  background: #020617;
}

.time-picker-appearance__controls {
  display: grid;
  gap: 12px;
...
.time-picker-appearance__column {
  display: grid;
  gap: 10px;
...
.time-picker-appearance__column label {
  align-items: center;
  color: #102a43;
  display: grid;
  font-size: 13px;
...
.time-picker-appearance__column label > span {
  min-width: 0;
  overflow: hidden;
...
.time-picker-appearance__column input,
.time-picker-appearance__column select {
...
.time-picker-appearance__column input[type='color'] {
  padding: 2px;
}

.time-picker-appearance__column input[type='checkbox'] {
  min-height: auto;
  padding: 0;
  width: auto;
}
