...
const props = withDefaults(defineProps<LayoutProps>(), {
  ...
  topbarTextColor: '#14221f',
  topbarRadius: 0,
  topbarBorderColor: '1px solid #cdded7',
  sidebarBackgroundColor: '#263d6f',
  sidebarTextColor: '#dde0fe',
  sidebarRadius: 0,
  sidebarBorderColor: '1px solid #cdded7',
  sidebarPadding: 12,
  contentBackgroundColor: '#ffffff',
  contentTextColor: '#14221f',
  contentPadding: 0,
  contentRadius: 0,
  footerBackgroundColor: '#ffffff',
  footerTextColor: '#6f5a25',
  footerRadius: 0,
  footerBorderColor: '1px solid #cdded7'
})
