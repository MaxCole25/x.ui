...
const darkDateTimePickerTheme = {
  modelValue: '2026-05-12 21:30',
  placeholder: '暗色日期时间',
  prefix: '夜间',
  clearable: true,
...
<template>
  <Story title="Form 组件/DateTimePicker 日期时间选择器" group="components">
    ...
    <Variant title="外观接口">
      <div class="date-time-picker-appearance">
        <div class="date-time-picker-appearance__preview">
          ...
          <div class="date-time-picker-appearance__preview-parent is-dark">
            <XDateTimePicker v-bind="darkDateTimePickerTheme" />
          </div>
        </div>
...
.date-time-picker-appearance__preview-parent.is-dark {
  background: #020617;
}
