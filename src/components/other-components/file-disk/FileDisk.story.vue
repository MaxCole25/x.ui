...
const borderColor = ref('#cbd5e1')
const headerBackgroundColor = ref('#f8fafc')
const toolbarBackgroundColor = ref('#ffffff')
const itemBackgroundColor = ref('#ffffff')
const itemHoverBackgroundColor = ref('#eff6ff')
const itemActiveBackgroundColor = ref('#eff6ff')
const itemActiveTextColor = ref('#102a43')
const iconColor = ref('#334155')
const activeIconColor = ref('#155e75')
const emptyBackgroundColor = ref('#ffffff')
const dragOverBackgroundColor = ref('rgba(14, 116, 144, 0.12)')
let idSeed = 100
...
<template>
  <Story title="其它组件/文件磁盘 FileDisk" group="components">
    <Variant title="外观接口">
      <div class="file-disk-story">
        <div class="file-disk-story__controls">
          ...
          <label>次级文字 <input v-model="mutedTextColor" type="color" /></label>
          <label>边框 <input v-model="borderColor" type="color" /></label>
          <label>头部背景 <input v-model="headerBackgroundColor" type="color" /></label>
          <label>工具栏背景 <input v-model="toolbarBackgroundColor" type="color" /></label>
          <label>文件项背景 <input v-model="itemBackgroundColor" type="color" /></label>
          <label>文件项悬浮 <input v-model="itemHoverBackgroundColor" type="color" /></label>
          <label>文件项选中 <input v-model="itemActiveBackgroundColor" type="color" /></label>
          <label>选中文字 <input v-model="itemActiveTextColor" type="color" /></label>
          <label>图标 <input v-model="iconColor" type="color" /></label>
          <label>激活图标 <input v-model="activeIconColor" type="color" /></label>
          <label>空状态背景 <input v-model="emptyBackgroundColor" type="color" /></label>
          <label>
            视图
