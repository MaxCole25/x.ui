...
<template>
  <Story title="组件/标签页 Tabs" group="components">
    <Variant title="交互调试">
      <div style="display: grid; gap: 12px">
        <div style="display: flex; flex-wrap: wrap; gap: 12px; font-size: 13px">
          ...
          <select v-model="size">
            ...
            <option value="default">中尺寸</option>
    ...
    <Variant title="自定义标签">
      <XTabs v-model="active" :items="tabs" closable>
        <template #label="{ item, active: isActive }">
          <span style="display: inline-flex; align-items: center; gap: 8px; min-width: 0">
            <span :style="{ color: isActive ? '#155e75' : '#6b7c93' }">#</span>
